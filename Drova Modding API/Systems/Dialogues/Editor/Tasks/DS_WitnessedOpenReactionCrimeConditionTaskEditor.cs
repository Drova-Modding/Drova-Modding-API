...
{
    /// <summary>
    /// Task editor for <see cref="DS_WitnessedOpenReactionCrimeConditionTask"/>
    /// </summary>
    public class DS_WitnessedOpenReactionCrimeConditionTaskEditor : DrawTaskEditor
    {
        private DS_WitnessedOpenReactionCrimeConditionTask? _castedTask;
        private GUIDropdown? _crimeTypeDropdown;

        /// <inheritdoc />
        public override void Init()
        {
            _castedTask ??= Task.TryCast<DS_WitnessedOpenReactionCrimeConditionTask>();
        ...
        public override Rect DrawTask(Vector2 position)
        {
            ...
            GUI.Box(drawRect, new GUIContent("DS_WitnessedOpenReactionCrimeConditionTask", "Check if owner witnessed a specific crime of player"), EditorBoxStyles.Task);
