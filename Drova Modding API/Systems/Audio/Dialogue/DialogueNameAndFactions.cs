namespace Drova_Modding_API.Systems.Audio.Dialogue
{
    internal static class DialogueNameAndFactions
    {
        ...
        public readonly static string[] NEMENTON = [NEMENTON_LEADER, NEMENTON_GATE_NORTH, NEMENTON_GATE_SOUTH, NEMENTON_LAUDINE, NEMENTON_SISTER, NEMENTON_GATE_HAIN, "Henik", "Asmus", "Mombert", "Myrte", "Femke", "Lio", "Oskar", "Gerion", "Luten", "Olga", "Gradan", "Chunnaic", "Bonny", "Dunja", "Mumme", "Kellan", "Muc", "Helma", "Angus", "Etzel", "Fia", "Rura", "Humbert", "Karotte", "Junali", "Aiko", "Adela", "Kendrick", "Jennifer", "Swenn", "Enya", "Harvey", "Kerr", "Fester", "Kati", "Teigen", "Niala", "Colin", "Adwin", "Hailey", "Gilwar", "Farona", "Minira", "Willi", "Erwin"];
