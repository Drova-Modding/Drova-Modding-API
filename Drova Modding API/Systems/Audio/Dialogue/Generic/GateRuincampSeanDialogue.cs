...
{
    internal class GateRuincampSeanDialogue : IGenericDialogueHandler
    {
        private const string DIALOGUE_NAME = "DT_Gate_Ruinenlager_UpperTown_Sean";
        ...
        public void HandleDialogue(DialogueTree tree, StringBuilder dialogStringBuilder, Dictionary<string, int> actorMapping)
        {
            for (int i = 0; i < tree.allNodes.Count; i++)
            {
                ...
                string actorName = DialogueNameAndFactions.GATE_UPPER_SEAN;
                dialogStringBuilder
