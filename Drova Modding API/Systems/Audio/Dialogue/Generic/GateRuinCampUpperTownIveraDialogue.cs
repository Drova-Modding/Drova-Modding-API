...
{
    internal class GateRuinCampUpperTownIveraDialogue : IGenericDialogueHandler
    {
        private const string DIALOGUE_NAME = "DT_Gate_Ruinenlager_UpperTown";
        ...
        public void HandleDialogue(DialogueTree tree, StringBuilder dialogStringBuilder, Dictionary<string, int> actorMapping)
        {
            for (int i = 0; i < tree.allNodes.Count; i++)
            {
                ...
                string actorName = DialogueNameAndFactions.GATE_UPPER_IVERA;
                dialogStringBuilder
